        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                <a href="/#" className="mb-6 inline-block max-w-[160px]">
                  <img
                    src="https://www.therealestatevoice.com.au/wp-content/uploads/2020/04/logo-header-colour.png"
                    alt="logo"
                ...
                Welcome to EagleSoftware - your trusted partner for innovative software solutions. We deliver cutting-edge products and services tailored to your needs. Join us in transforming ideas into reality. Explore our solutions today.
                </p>
            ...
            <LinkGroup header="Company">
              ...
              <NavLink link="/#Blogs" label="Success History" />
...
const StyledNavLink = ({ link, label }) => {
  return (
    <li>
      <a
        href={link}
        className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6"
        style={{ textDecoration: 'none' }} // Apply textDecoration directly
      >
        {label}
      </a>
    </li>
